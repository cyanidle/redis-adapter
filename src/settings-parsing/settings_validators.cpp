...
const QString &Settings::ChooseJsonFormat::name()
{
    static QString stName = "JsonFormat: compact/indented";
    return stName;
}
...
const QString &Settings::StringToFileSize::name()
{
    static QString stName = "Filesize String: <number><G/M/K>";
    return stName;
}
