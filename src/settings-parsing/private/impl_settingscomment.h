...
private: void _priv_comment_test_root () const noexcept { \
        _has_Is_Serializable(); \
} \
QString _priv_comment_get_root const { \
return QStringLiteral(__VA_ARGS__); \
Q_PROPERTY(QString __root_comment__ READ _priv_comment_get_root) \
public:
