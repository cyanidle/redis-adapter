...
struct FilterIter {
    ...
    template<typename T>
    typename std::enable_if<MethodInfo<T>::IsMethod && std::is_pointer<value_type>::value, bool>::type
    apply(const value_type& val) const {
        return val->*m_filter();
    }
    template<typename T>
    typename std::enable_if<FuncInfo<T>::IsFunction, bool>::type
    apply(const value_type& val) const {
        return val.*m_filter();
    }
private:
...
struct FilterHolder {
    ...
    {}
    iterator begin() {
        return iterator(m_firstCont->begin(), m_firstCont->end(), m_filter);
    }
    iterator end() {
        return iterator(m_firstCont->end(), m_firstCont->end(), m_filter);
    }
    const_iterator begin() const {
        return const_iterator(m_firstCont->begin(), m_firstCont->end(), m_filter);
    }
    const_iterator end() const {
        return const_iterator(m_firstCont->end(), m_firstCont->end(), m_filter);
    }
